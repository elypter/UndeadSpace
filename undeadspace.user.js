// ==UserScript==
// @name Undead Space
// @namespace undead space
// @description makes unused space that was used by ads, annoyances or inflexible design to display the actual content
// @match *://*/*
// @version 1
// @grant GM.getValue
// @grant GM.setValue
...
https://github.com/elypter/UndeadSpace/ 
License: GPL3
*/
...
var black_keywords=["results","main","article","story","content","body","guide","html5","watch","background","container","panel"];

//id and classes that  any of these keycontainwords will not be modified
var white_names = ["side","preload","left","right","content","account__section","drag-and-drop"];
...
var ignore_tags = ["a","A","script","SCRIPT","body","BODY","li","LI","ul","UL","br","BR","h5","H5","b","B","strong","STRONG","svg","SVG","path","PATH","h2","H2",
                   "code","CODE","h3","H3","h1","H1","h4","H4"];//,"noscript","NOSCRIPT"

var toggle_rule_saving_handle;

var toggle_statistics_saving_handle;

var stop_scrolling_triggers = false;
...
console.log("rule 1: "+generated_rules[0]);
...
var mutation_check=GM_SuperValue.get ("mutation_check")==true?GM_SuperValue.get ("mutation_check"):0; //1=yes 2=no change value in memory tab
...
function counted_element_walker(elm,orig){
    ...
    if(stop_scrolling_triggers==true) window.addEventListener("scroll", function (event) {
...
function element_walker_all(startElem) {
    ...
    if(elm instanceof Element && ignore_tags.indexOf(elm.tagName.toString()) == -1 && getComputedStyle(elm)) {
        ...
        if (/*(getComputedStyle(elm).getPropertyValue("position") == "absolute") ||*/
            (getComputedStyle(elm).getPropertyValue("max-width").toLowerCase() != "") ||
            (getComputedStyle(elm).getPropertyValue("width").toLowerCase() != "100%") ||
